...
// .wrangler/tmp/bundle-DKUOoC/checked-fetch.js
...
__name(handleAdminChangeQuestionAuthor, "handleAdminChangeQuestionAuthor");
...
__name(handleAdminChangeAnswerAuthor, "handleAdminChangeAnswerAuthor");
...
__name(handleQuestionSitemap, "handleQuestionSitemap");
...
__name(handleRobotsTxt, "handleRobotsTxt");
...
function generateQAPageStructuredData(question, answers, baseUrl) {
  const cleanText = /* @__PURE__ */ __name((text) => {
    if (!text) return "";
    return text.replace(/<[^>]*>/g, "").replace(/"/g, '\\"').replace(/\n/g, " ").replace(/\s+/g, " ").trim();
  }, "cleanText");
  const toISO8601 = /* @__PURE__ */ __name((dateStr) => {
    if (!dateStr) return "";
...
__name(generateQAPageStructuredData, "generateQAPageStructuredData");
        ...
        <div id="admin-users" class="admin-content">
          <div class="admin-card">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
              <h3 style="margin: 0;">\${this.t('admin.all_users', 'T\xFCm Kullan\u0131c\u0131lar')} (\${users.users.length})</h3>
...
// .wrangler/tmp/bundle-DKUOoC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-DKUOoC/middleware-loader.entry.ts
